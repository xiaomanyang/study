package com.wcl.productserver.plugins;
...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir(projectPath + "/netflixp/user-server/src/main/java");
        ...
        pc.setParent("com.wcl.userserver");
        pc.setEntity("entity");
        pc.setMapper("mapper");
...
*/
        ...
        strategy.setInclude("sys_user,sys_role".split(","));
        // 配置数据表与实体类名之间映射的策略
